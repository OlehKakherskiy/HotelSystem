 ...
 */
public class RefuseReservationProcessingCommandTest {
    ...
    public void process() throws Exception {
        ...
        reservationService.refuseReservationProcessing(reservationStub);
        EasyMock.expectLastCall();
        ...
        ICommand refuseProcessingCommand = new RefuseReservationProcessingCommand();
        refuseProcessingCommand.setServiceManager(serviceManager);
        Assert.assertEquals(WebPageConstant.INDEX.getPath(), refuseProcessingCommand.process(request, null));
