...
<jsp:useBean id="user" scope="session" type="main.java.com.hotelSystem.model.User"/>
<c:if test="${newReservation}">
    <jsp:useBean id="requestParameters" scope="request" type="java.util.Map"/>
</c:if>
<c:if test="${!newReservation}">
    <jsp:useBean id="currentReservation" scope="session" type="main.java.com.hotelSystem.model.Reservation"/>
</c:if>
