...
<jsp:useBean id="hotelRoom" type="main.java.com.hotelSystem.model.HotelRoom" scope="request"/>
<jsp:useBean id="user" type="main.java.com.hotelSystem.model.User" scope="session"/>
