...
public class FillNewReservationCommand extends AbstractCommand {
    ...
    public String process(HttpServletRequest request, HttpServletResponse response) {
        ReservationService reservationService = serviceManager.getInstance(AbstractReservationService.class);
    ...
    private List<ParameterValue> getParameterValueList(HttpServletRequest request) {
        ...
        return parameterValueService.getParamValueList(parseParameterValueList(request));
    }

    private List<Integer> parseParameterValueList(HttpServletRequest request) {
        return null; //TODO: !!!
    }
}
